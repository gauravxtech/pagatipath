        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-16">
            {contactInfo.map((info, index) => (
              <Card key={index} className="bg-white dark:bg-card shadow-card hover:shadow-xl transition-all duration-300 overflow-hidden group border dark:border-border">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {/* Contact Form */}
            <Card className="bg-white dark:bg-card shadow-card border dark:border-border">
            ...
            <div className="space-y-6">
              {/* Map Placeholder */}
              <Card className="bg-white dark:bg-card shadow-card overflow-hidden border dark:border-border">
                <CardContent className="p-0">
              ...
              <Card className="bg-white dark:bg-card shadow-card border dark:border-border">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-6 text-foreground text-center">Connect With Us</h3>
                  <div className="flex justify-center gap-4">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className={`w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center transition-all ${social.color} hover:scale-110`}
              ...
              {/* Quick Info */}
              <Card className="bg-gradient-to-r from-primary to-primary/90 text-white shadow-card border-0">
