    ...
    return (
        <div className="min-h-screen bg-gradient-subtle">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gray-800">Founding Body</h2>
            ...
            <section className="py-16 md:py-20">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">Leadership Team</h2>
                        ...
                        {leadership.map((leader, index) => (
                            <Card key={index} className="bg-white shadow-soft border border-gray-100 hover:shadow-card transition-shadow">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <h3 className="text-lg font-bold mb-2 text-gray-800">{leader.name}</h3>
                        ...
                        {timeline.map((item, index) => (
                            <div key={index} className="flex items-start mb-8 last:mb-0">
                                ...
                                <div className="flex-1 ml-6">
                                    <Card className="bg-white shadow-soft border border-gray-100">
                                        <CardContent className="p-6">
                                            <h3 className="text-lg font-bold mb-2 text-gray-800">{item.event}</h3>
